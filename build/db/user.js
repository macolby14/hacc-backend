...
var UserAccount_1 = __importDefault(require("../entity/UserAccount"));
// TODO: Could this call too early? Do we need to verify first connection was verified
function addPointsToUserScore(user, pointsToAdd) {
    return __awaiter(this, void 0, void 0, function () {
        var connection, userRepository, foundUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connection = typeorm_1.getConnection();
                    userRepository = connection.getRepository(UserAccount_1.default);
...
function getUsersByScore() {
    return __awaiter(this, void 0, void 0, function () {
        var connection, userRepository, users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connection = typeorm_1.getConnection();
